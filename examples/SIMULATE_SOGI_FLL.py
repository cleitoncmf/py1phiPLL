...
fig_v = plt.figure() 
plt.plot(sogi_fll_1.t,v_in(sogi_fll_1.t),'k--',linewidth=2)
plt.plot(sogi_fll_1.t,sogi_fll_1.v_alpha,linewidth=3,alpha=0.7)
plt.plot(sogi_fll_1.t,sogi_fll_1.v_beta,linewidth=3)
plt.grid()
...
fig_e = plt.figure()
plt.plot(sogi_fll_1.t,sogi_fll_1.e,linewidth=2)
plt.grid()
...
# Plotting the results: angular frequency
fig_w = plt.figure()
plt.plot(sogi_fll_1.t,sogi_fll_1.w,linewidth=2)
plt.grid()
