...
from py1phiPLL.PLL import SOGI 
...
y0 = [0.0, 0.0]
sol = solve_ivp(fun=SOGI,t_span=(t_start,t_end), y0=y0, t_eval=t, args=(v_in,sogi_1), method='BDF')


# Plotting the results: v_in, v_alpha, v_beta
fig_v = plt.figure() 
plt.plot(sogi_1.t,v_in(sogi_1.t),'k--',linewidth=2)
plt.plot(sogi_1.t,sogi_1.v_alpha,linewidth=3,alpha=0.7)
plt.plot(sogi_1.t,sogi_1.v_beta,linewidth=3)
plt.grid()
...
fig_e = plt.figure()
plt.plot(sogi_1.t,sogi_1.e,linewidth=2)
plt.grid()
